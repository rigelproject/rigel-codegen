...
SDValue DAGCombiner::ReduceLoadWidth(SDNode *N) {
  ...
  if (Opc == ISD::SIGN_EXTEND_INREG) {
    ...
    // Another special-case: SRL is basically zero-extending a narrower
    // value.
  ...
  //MRJ 20110727 Backported bugfix from r124587
	//(see http://lists.cs.uiuc.edu/pipermail/llvmdev/2011-July/041953.html)
